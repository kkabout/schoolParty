...
public class aliMessageSend {
    ...
    private static String accessKeyId = "LTAI4u6rSKCRKRTm";
    private static String accessKeySecret = "dDlEQNMl8TK5VaWrAlkeOwaJgu8BOr";
    private static String signName = "康健";
    private static String templeteCode = "SMS_139986150";
    private static String code="";

    public static void setMobile(String mobile) {
        aliMessageSend.mobile = mobile;
    }

    public static void setCode(String code) {
        aliMessageSend.code = code;
    }
