	...
	<div class="friends">
		...
		<div class="flist_ct col-md-6">
	    	    <table class="flist_tb" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <c:forEach items="${foucsUserInfo}" var="foucsUsers">
                        <tr class="flist_tr friLi" name="" id="friend1" >
                            <td class="pic col-md-1"><img src="${foucsUsers.img}" alt="" width="150px" height="150px;"></td>
                            <td class="info col-md-9"><p class="name">${foucsUsers.nickname}</p><p class="oth">关注：${foucsUsers.focuscount}</p><p class="oth">粉丝：${foucsUsers.followcount}</p><p class="oth">个性签名：${foucsUsers.signture}</p></td>
                            <td class="col-md-2"><button class="btn btn-primary"><a href="/user/otherinfo?nickname=${foucsUsers.nickname}&curid=${user.uid}">查看详细信息</a></button></td>
                        </tr>
                    </c:forEach>
